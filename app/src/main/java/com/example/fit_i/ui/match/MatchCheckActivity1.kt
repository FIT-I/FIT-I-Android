...
class MatchCheckActivity1:AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnNext.setOnClickListener{
            ...
            fun makeToast() {
                Toast.makeText(this@MatchCheckActivity1, "매칭 요청을 완료하였습니다.", Toast.LENGTH_SHORT).show()
...
//                startActivity(intent)
            ...
            fun logout() {
                ...
                customerService.matcingPlz(MatchingRequest(end!!,start!!,"CUSTOMER_GO") ,id).enqueue(object : Callback<BaseResponse> {
