...
//            //setDrawLabels(true) // 라벨 표시 여부
//            setCenterAxisLabels(true)
//            valueFormatter = IndexAxisValueFormatter(listOf("10", "20", "15", "12", "11"))
//
//        }
//
//        // y 축 설정
...
////            valueFormatter = IndexAxisValueFormatter(listOf("5점", "4점", "3점", "2점", "1점"))
//
//            setDrawGridLines(false)
//            setDrawAxisLine(false)
//            setDrawLabels(true) // Y축 라벨 표시 여부
//            valueFormatter = IndexAxisValueFormatter(listOf("항목 1", "항목 2", "항목 3", "항목 4", "항목 5"))
//        }
//
